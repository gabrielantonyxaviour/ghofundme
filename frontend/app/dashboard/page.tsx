...
const page: NextPage = () => {
  ...
  return (
    <div className="relative bg-gray-200 w-full h-screen overflow-hidden text-left text-5xl text-white font-monument-extended">
      ...
      <div className="absolute top-[231px] left-[616px] w-[1194px] h-[603px] text-xl text-gray-100 font-sans">
      
        <div className="absolute top-[0px] left-[0px] rounded-xl  box-border w-[1194px] h-[603px] border-[2px] border-dashed border-[#025231]" />
